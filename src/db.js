...
const defaults = {
    ...
    ENABLE_DBB_STRATEGY: 'false',
    DBB_MODE: 'double',
    DBB_TIMEFRAME: '1m',
    DBB_PERIOD: '20',
    DBB_STD_DEV_OUTER: '2.0',
    DBB_STD_DEV_INNER: '1.0',
    DBB_LOOKBACK_CANDLES: '4',
    ...
    ENABLE_SNEAKY_PIVOT_STRATEGY: 'false',
    SNEAKY_PIVOT_TIMEFRAME: '15m',
    SNEAKY_PIVOT_ENABLE_PDR_HIGH: 'true',
    SNEAKY_PIVOT_ENABLE_PDR_LOW: 'true',
    SNEAKY_PIVOT_ENABLE_PDS_HIGH: 'true',
    SNEAKY_PIVOT_ENABLE_PDS_LOW: 'true',
    SNEAKY_PIVOT_SWING_PERIOD: '3',
