...
function getConfig() {
    ...
    return {
        ...
        BB_MODE: dbConfig.BB_MODE || 'single',
        BB_DOUBLE_BEHAVIOR: dbConfig.BB_DOUBLE_BEHAVIOR || 'original',
        ...
        BB_STD_DEV_INNER: parseFloat(dbConfig.BB_STD_DEV_INNER) || 1.0,
        BB_LOOKBACK_CANDLES: parseInt(dbConfig.BB_LOOKBACK_CANDLES) || 4,
        ENABLE_SNEAKY_PIVOT_STRATEGY: dbConfig.ENABLE_SNEAKY_PIVOT_STRATEGY === 'true',
        ENABLE_REVERSE_LIQUIDATION_STRATEGY: dbConfig.ENABLE_REVERSE_LIQUIDATION_STRATEGY === 'true',
        SNEAKY_PIVOT_TIMEFRAME: dbConfig.SNEAKY_PIVOT_TIMEFRAME || '15m',
        SNEAKY_PIVOT_ENABLE_PDR_HIGH: dbConfig.SNEAKY_PIVOT_ENABLE_PDR_HIGH !== 'false',
        SNEAKY_PIVOT_ENABLE_PDR_LOW: dbConfig.SNEAKY_PIVOT_ENABLE_PDR_LOW !== 'false',
        SNEAKY_PIVOT_ENABLE_PDS_HIGH: dbConfig.SNEAKY_PIVOT_ENABLE_PDS_HIGH !== 'false',
        SNEAKY_PIVOT_ENABLE_PDS_LOW: dbConfig.SNEAKY_PIVOT_ENABLE_PDS_LOW !== 'false',
        SNEAKY_PIVOT_SWING_PERIOD: parseInt(dbConfig.SNEAKY_PIVOT_SWING_PERIOD) || 3,
        SNEAKY_PIVOT_BUY_SIGNAL: dbConfig.SNEAKY_PIVOT_BUY_SIGNAL || 'buy',
        SNEAKY_PIVOT_SELL_SIGNAL: dbConfig.SNEAKY_PIVOT_SELL_SIGNAL || 'sell',
        SNEAKY_PIVOT_BYPASS_ON_POSITION: dbConfig.SNEAKY_PIVOT_BYPASS_ON_POSITION || 'false',
        ...
        ATR_TP_ENABLED: dbConfig.ATR_TP_ENABLED === 'true',
        ATR_SL_ENABLED: dbConfig.ATR_SL_ENABLED === 'true',
        ATR_TIMEFRAME: dbConfig.ATR_TIMEFRAME || '15m',
        ATR_PERIOD: parseInt(dbConfig.ATR_PERIOD) || 14,
        ATR_BASELINE_PERIOD: parseInt(dbConfig.ATR_BASELINE_PERIOD) || 20,
        ATR_MIN_MULTIPLIER: parseFloat(dbConfig.ATR_MIN_MULTIPLIER) || 0.70,
        ATR_MAX_MULTIPLIER: parseFloat(dbConfig.ATR_MAX_MULTIPLIER) || 1.80,
        ...
        RUNAWAY_HELPER_TIMEOUT: dbConfig.RUNAWAY_HELPER_TIMEOUT !== undefined && dbConfig.RUNAWAY_HELPER_TIMEOUT !== '' ? parseInt(dbConfig.RUNAWAY_HELPER_TIMEOUT) : 70,
