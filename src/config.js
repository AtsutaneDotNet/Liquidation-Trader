...
function getConfig() {
    ...
    return {
        ...
        RSI_TIMEFRAME: dbConfig.RSI_TIMEFRAME || '15m',
        ...
        ADX_TIMEFRAME: dbConfig.ADX_TIMEFRAME || '15m',
        ADX_THRESHOLD: parseFloat(dbConfig.ADX_THRESHOLD) || 40,
        ...
        OFFSET_PERCENTAGE: parseFloat(dbConfig.OFFSET_PERCENTAGE) || 5.0,
        ...
        TRAILING_PROFIT_PERCENTAGE: parseFloat(dbConfig.TRAILING_PROFIT_PERCENTAGE) || 0.5,
        TRAILING_ACTIVATION_PERCENTAGE: parseFloat(dbConfig.TRAILING_ACTIVATION_PERCENTAGE) || 1.0,
        TRADE_LEVERAGE: parseInt(dbConfig.TRADE_LEVERAGE) || 10,
        TRADE_AMOUNT_PERCENTAGE: parseFloat(dbConfig.TRADE_AMOUNT_PERCENTAGE) || 0.25,
        MAX_OPEN_POSITIONS: parseInt(dbConfig.MAX_OPEN_POSITIONS) || 1,
        CMC_API_KEY: dbConfig.CMC_API_KEY || '',
        CMC_RANK_LIMIT: parseInt(dbConfig.CMC_RANK_LIMIT) || 100,
        CMC_FILTER_ENABLED: dbConfig.CMC_FILTER_ENABLED === 'false',
        ENABLE_DCA_MARTINGALE: dbConfig.ENABLE_DCA_MARTINGALE === 'false',
        ENABLE_DYNAMIC_THRESHOLDS: dbConfig.ENABLE_DYNAMIC_THRESHOLDS === 'false',
