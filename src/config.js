...
function getConfig() {
    ...
    return {
        ...
        ENABLE_DBB_STRATEGY: dbConfig.ENABLE_DBB_STRATEGY === 'true',
        DBB_MODE: dbConfig.DBB_MODE || 'double',
        DBB_TIMEFRAME: dbConfig.DBB_TIMEFRAME || '1m',
        DBB_PERIOD: parseInt(dbConfig.DBB_PERIOD) || 20,
        DBB_STD_DEV_OUTER: parseFloat(dbConfig.DBB_STD_DEV_OUTER) || 2.0,
        DBB_STD_DEV_INNER: parseFloat(dbConfig.DBB_STD_DEV_INNER) || 1.0,
        DBB_LOOKBACK_CANDLES: parseInt(dbConfig.DBB_LOOKBACK_CANDLES) || 4,
