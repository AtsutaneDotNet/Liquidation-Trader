...
function getConfig() {
    ...
    return {
        ...
        VWAP_UPPER_SIGNAL: dbConfig.VWAP_UPPER_SIGNAL || 'short',
        VWAP_LOWER_SIGNAL: dbConfig.VWAP_LOWER_SIGNAL || 'long',
        RSI_OVERBOUGHT_SIGNAL: dbConfig.RSI_OVERBOUGHT_SIGNAL || 'short',
        RSI_OVERSOLD_SIGNAL: dbConfig.RSI_OVERSOLD_SIGNAL || 'long',
        ADX_THRESHOLD_DIR: dbConfig.ADX_THRESHOLD_DIR || 'under',
        ADX_PDI_SIGNAL: dbConfig.ADX_PDI_SIGNAL || 'short',
        ADX_MDI_SIGNAL: dbConfig.ADX_MDI_SIGNAL || 'long',
        FG_FEAR_SIGNAL: dbConfig.FG_FEAR_SIGNAL || 'long',
        FG_GREED_SIGNAL: dbConfig.FG_GREED_SIGNAL || 'short',
